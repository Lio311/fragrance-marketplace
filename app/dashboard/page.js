    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {[
          ...
          { icon: Star, label: 'דירוג ממוצע', value: '—', color: 'text-slate-500 bg-slate-50' },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link
          ...
          className="flex items-center gap-4 p-6 bg-white border border-surface-200 rounded-2xl hover:border-blue-300 hover:shadow-card-hover transition-all group"
        >
          <div className="size-12 rounded-xl bg-surface-50 flex items-center justify-center group-hover:bg-blue-50 transition-colors">
            <Package className="size-6 text-surface-600 group-hover:text-blue-500 transition-colors" />
          </div>
          <div>
        ...
        >
          <div className="size-12 rounded-xl bg-surface-50 flex items-center justify-center group-hover:bg-blue-50 transition-colors">
            <Plus className="size-6 text-surface-600 group-hover:text-blue-500 transition-colors" />
          </div>
          <div>
